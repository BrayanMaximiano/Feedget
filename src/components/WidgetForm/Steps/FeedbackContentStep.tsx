    ...
    return(
        <>
            ...
            <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
                <textarea 
                className="p-1 min-w-[304px] w-full  h-[100px] min-h-{204px} text-base placeholder-zinc-400 text-zinc-100 border-2 border-zinc-700 bg-transparent rounded-md focus:border-brand-500 focus:ring-brand-500 focus:ring-1 focus:outline-none resize-none scrollbar scrollbar-thumb-zinc-700 scrollbar-track-transparent scrollbar-thin"
